        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <Button variant="link" className="h-auto p-0 text-sm">Employee Handbook</Button>
              <Button variant="link" className="h-auto p-0 text-sm">IT Security Guidelines</Button>
              <Button variant="link" className="h-auto p-0 text-sm">Code of Ethics</Button>
            </CardContent>
          </Card>
        </div>
